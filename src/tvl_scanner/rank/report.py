...
def _summary_header(candidates: list[CandidateRecord], scan_date: date) -> str:
    ...
    return (
        ...
        f"To audit a candidate, say to Claude Code: `new audit on <target_name> at /home/dewaxindo/audit/{scan_date.isoformat()}-<slug>/` — "
...
def _candidate_body(candidate: CandidateRecord) -> str:
    ...
    lines.append("")
    lines.append(
        f"> `new audit on {candidate.target_name} at /home/dewaxindo/audit/"
