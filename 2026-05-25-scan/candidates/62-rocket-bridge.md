...
- Brand-new contract (55d old) — check initialization racing, first-caller bootstrap
  invariants
...
priority_score: 5.88
why_interesting: Bridge on arbitrum • $221,016 TVL • 55d old • no prior audits found
...
> Bridge on arbitrum • $221,016 TVL • 55d old • no prior audits found
...
- Brand-new contract (55d old) — check initialization racing, first-caller bootstrap invariants
...
> `new audit on rocket-bridge at ~/audit/2026-05-25-rocket-bridge/`
