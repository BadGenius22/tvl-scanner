...
- Brand-new contract (31d old) — check initialization racing, first-caller bootstrap
  invariants
- Real money at stake ($35,235,096 TVL) — favor impact-driven finding scoping
bounty_program: none
bounty_url: null
bounty_max_payout_usd: null
tvl_usd: 35235096.62449232
...
priority_score: 5.08
why_interesting: Synthetics on ethereum • $35,235,096 TVL • 31d old • audit_density=6
...
> Synthetics on ethereum • $35,235,096 TVL • 31d old • audit_density=6

## Summary

- **Chain**: ethereum
- **Primary contract**: `ethereum:defillama:alchemix-v3`
- **TVL**: $35.2M (35,235,096)
...
- Brand-new contract (31d old) — check initialization racing, first-caller bootstrap invariants
- Real money at stake ($35,235,096 TVL) — favor impact-driven finding scoping
...
> `new audit on alchemix-v3 at ~/audit/2026-05-25-alchemix-v3/`
