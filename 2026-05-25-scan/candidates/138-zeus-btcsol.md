---
target_name: zeus-btcsol
display_name: Zeus btcSOL
protocol_type: Liquid Restaking on solana
languages:
- rust
chains:
- solana
...
loc_estimate: null
docs_url: null
primary_contract: solana:defillama:zeus-btcsol
priority_score: 5.08
why_interesting: Liquid Restaking on solana • $621,675 TVL • 304d old • no prior audits
  found
...
> Liquid Restaking on solana • $621,675 TVL • 304d old • no prior audits found

## Summary

- **Chain**: solana
- **Primary contract**: `solana:defillama:zeus-btcsol`
- **TVL**: $622K (621,675)
- **Age**: 10mo (first seen 2025-07-25)
- **Languages**: rust
...
- **DefiLlama audit count**: 0 (from /protocol/zeus-btcsol detail)
...
> `new audit on zeus-btcsol at ~/audit/2026-05-25-zeus-btcsol/`
