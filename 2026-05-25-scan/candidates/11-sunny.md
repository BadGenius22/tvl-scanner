...
- No prior audits found in any source — start with standard sanity pass before specialized
  depth
- Real money at stake ($2,543,505 TVL) — favor impact-driven finding scoping
bounty_program: none
bounty_url: null
bounty_max_payout_usd: null
tvl_usd: 2543505.927314198
...
loc_estimate: null
docs_url: null
primary_contract: solana:defillama:sunny
priority_score: 6.52
why_interesting: Yield on solana • $2,543,505 TVL • 180d old • no prior audits found
...
> Yield on solana • $2,543,505 TVL • 180d old • no prior audits found

## Summary

- **Chain**: solana
- **Primary contract**: `solana:defillama:sunny`
- **TVL**: $2.5M (2,543,505)
...
- **DefiLlama audit count**: 0 (from /protocol/sunny detail)
...
> `new audit on sunny at ~/audit/2026-05-25-sunny/`
