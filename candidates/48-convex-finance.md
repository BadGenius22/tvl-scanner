...
- source: homepage_scrape
  ...
  title: mixbytes audit cited on protocol homepage
  published_at: null
- source: homepage_scrape
  url: https://www.convexfinance.com/
  title: peckshield audit cited on protocol homepage
  published_at: null
under_audited: false
edge_match_keywords: []
focus_areas_suggested:
- Real money at stake ($578,682,660 TVL) — favor impact-driven finding scoping
bounty_program: immunefi
bounty_url: https://immunefi.com/bounty/convexfinance/
bounty_max_payout_usd: 1000000
tvl_usd: 578682660.4025551
...
priority_score: 5.26
why_interesting: 'Yield on ethereum • $578,682,660 TVL • 180d old • ~40709 LOC • audit_density=14
  • bounty: immunefi'
...
> Yield on ethereum • $578,682,660 TVL • 180d old • ~40709 LOC • audit_density=14 • bounty: immunefi

## Summary

- **Chain**: ethereum
- **Primary contract**: `ethereum:defillama:convex-finance`
- **TVL**: $578.7M (578,682,660)
...
- Sources found:
  ...
  - `homepage_scrape` (4pt): mixbytes audit cited on protocol homepage
  - `homepage_scrape` (4pt): peckshield audit cited on protocol homepage
...
> `new audit on convex-finance at ~/audit/2026-05-26-convex-finance/`
