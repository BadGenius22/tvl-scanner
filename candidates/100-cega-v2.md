...
loc_estimate: null
docs_url: null
primary_contract: arbitrum:defillama:cega-v2
priority_score: 4.8
why_interesting: Options on arbitrum • $107,580 TVL • 180d old • no prior audits found
...
> Options on arbitrum • $107,580 TVL • 180d old • no prior audits found

## Summary

- **Chain**: arbitrum
- **Primary contract**: `arbitrum:defillama:cega-v2`
- **TVL**: $108K (107,580)
...
- **DefiLlama audit count**: 0 (from /protocol/cega-v2 detail)
...
> `new audit on cega-v2 at ~/audit/2026-05-26-cega-v2/`
