...
- Check integration seams with external lending/yield primitive — cross-protocol trust
  boundary
- Brand-new contract (7d old) — check initialization racing, first-caller bootstrap
  invariants
- Real money at stake ($3,257,220 TVL) — favor impact-driven finding scoping
bounty_program: none
bounty_url: null
bounty_max_payout_usd: null
tvl_usd: 3257220.0390191157
...
priority_score: 5.1
why_interesting: 'Lending on ethereum • $3,257,220 TVL • 7d old • audit_density=6
  • edge-match: silo'
...
> Lending on ethereum • $3,257,220 TVL • 7d old • audit_density=6 • edge-match: silo
...
- Brand-new contract (7d old) — check initialization racing, first-caller bootstrap invariants
- Real money at stake ($3,257,220 TVL) — favor impact-driven finding scoping
...
> `new audit on silo-v3 at ~/audit/2026-05-26-silo-v3/`
