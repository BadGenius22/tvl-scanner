...
- Brand-new contract (22d old) — check initialization racing, first-caller bootstrap
  invariants
bounty_program: none
bounty_url: null
bounty_max_payout_usd: null
tvl_usd: 121679.84662751787
...
priority_score: 5.14
why_interesting: Yield Aggregator on base • $121,679 TVL • 22d old • audit_density=1
...
> Yield Aggregator on base • $121,679 TVL • 22d old • audit_density=1
...
- Brand-new contract (22d old) — check initialization racing, first-caller bootstrap invariants

## Vault handoff (Phase 2a)

To audit this candidate, say to Claude Code:

> `new audit on tizi at ~/audit/2026-05-26-tizi/`
